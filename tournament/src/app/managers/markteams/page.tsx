...
function MarkTeamsPage(){
    ...
    return(
        <div className="h-screen relative flex flex-col items-center justify-center text-white">
            <div className="relative z-10 orange-yellow-gradient w-[52%] h-[60vh] min-h-[52%] max-h-[70%] flex flex-col justify-center items-center rounded-xl pb-3">
                <div className='pt-14'>
                  <p className='text-4xl font-bold'>Mark Teams</p>  
                </div>
                <div className='flex flex-col gap-8 justify-center overflow-y-auto pb-4 h-full'>
