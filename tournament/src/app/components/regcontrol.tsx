...
const RegControl: React.FC<RegControlProps> = ({ closeOverlay }) => {
    ...
    const deleteTournament = async (id: string) => {
        try {
            await axios.delete(`${process.env.NEXT_PUBLIC_BACKEND_URL}/api/tournament/${id}`);
    ...
    const saveTournament = async () => {
        ...
        try {
            ...
            const response = await axios.post(`${process.env.NEXT_PUBLIC_BACKEND_URL}/api/tournament`, {
                name: tournamentName,
    ...
    const closeRegistration = async () => {
        ...
        try {
            const response = await axios.patch(
                `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/tournament/${tournamentId}/registration-status`,
